...
Quad2::Quad2(OpenGLContext *Context) : Drawable(Context), context(Context)
{}

void Quad2::createVBOdata(){
    GLuint idx[6]{0, 1, 2, 0, 2, 3};
    glm::vec4 vert_pos[4] {glm::vec4(-1.f, -1.f, 0.9f, 1.f),
                           glm::vec4(1.f, -1.f, 0.9f, 1.f),
                           glm::vec4(1.f, 1.f, 0.9f, 1.f),
                           glm::vec4(-1.f, 1.f, 0.9f, 1.f)};

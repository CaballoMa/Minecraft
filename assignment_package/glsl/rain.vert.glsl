...
void main()
{
    vec3 velocity = vec3(0.f,60.f,0.f);

    vec4 d = vec4(velocity,0.f) * ((u_Time+1.f)/100.f);
    vec4 offsetPos = vs_Pos + vec4(vs_OffsetInstanced, 0.f) - mod(d, (vs_OffsetInstanced.y + 340));
    fs_Pos = offsetPos;
